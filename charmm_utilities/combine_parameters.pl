...
this script, to merge parameter files. TG - version of 24-Oct-2013
EOF
...
my $input_version='$Id: 24-Oct-2013 $';
...
print <<EOF;
* Combined parameter file generated by: $commandline
* THIS FILE IS NOT AN OFFICIAL VERSION AND IT MAY CONTAIN SERIOUS ERRORS. 
* Date: $input_date
